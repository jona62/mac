...
namespace native_registry {
    ...
    inline const std::vector<NativeDefinition>& all() {
        static const std::vector<NativeDefinition> defs = {
            ...
            {"timeline", NativeVisibility::Internal, "fun(0)", "Internal timeline constructor.",
                {{{}, "TimelineEngine", "Create the native timeline engine object used by the prelude."}},
                [] { return std::make_shared<callable::TimelineCreateFunction>(); }},
            ...
            {"_meme_save", NativeVisibility::Internal, "fun(6)", "Internal meme saver.",
                {{{"templatePath", "topText", "bottomText", "width", "height", "path"}, "bool", "Render and save a meme image."}},
            ...
            {"_timeline_keyframe", NativeVisibility::Internal, "fun(2)", "Internal timeline keyframe helper.",
                {{{"timeline", "meme"}, "TimelineEngine", "Add a keyframe to a native timeline."}},
                [] { return std::make_shared<callable::TimelineKeyframeFunction>(); }},
            {"_timeline_transition", NativeVisibility::Internal, "fun(3)", "Internal timeline transition helper.",
                {{{"timeline", "durationMs", "transitionType"}, "TimelineEngine", "Add a transition to a native timeline."}},
                [] { return std::make_shared<callable::TimelineTransitionFunction>(); }},
            {"_timeline_hold", NativeVisibility::Internal, "fun(2)", "Internal timeline hold helper.",
                {{{"timeline", "durationMs"}, "TimelineEngine", "Hold the current frame on a native timeline."}},
                [] { return std::make_shared<callable::TimelineHoldFunction>(); }},
            {"_timeline_loop", NativeVisibility::Internal, "fun(2)", "Internal timeline loop helper.",
                {{{"timeline", "count"}, "TimelineEngine", "Set the loop count on a native timeline."}},
                [] { return std::make_shared<callable::TimelineLoopFunction>(); }},
